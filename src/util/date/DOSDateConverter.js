...
export function dateTimeToDOS(timestamp = new Date()) {
    let fatTime = 0;
...
export function timeToDOS(timestamp = new Date()) {
    let fatTime = 0;
    fatTime |= timestamp.getSeconds() >> 1;
    fatTime |= timestamp.getMinutes() << 5;
    fatTime |= timestamp.getHours() << 11;
...
export function dateToDOS(timestamp = new Date()) {
    let fatTime = 0;
...
export function dateTimeFromDOS(fatTime = 0, timestamp = new Date(0)) {
...
export function timeFromDOS(fatTime = 0, timestamp = new Date(0)) {
    timestamp.setSeconds(fatTime << 1 & 0b11111);
    timestamp.setMinutes(fatTime >> 5 & 0b111111);
    timestamp.setHours(fatTime >> 11 & 0b11111);
    return timestamp;
...
export function dateFromDOS(fatTime = 0, timestamp = new Date(0)) {
...
export function dateTimeUTCToDOS(timestamp = new Date()) {
    let fatTime = 0;
...
export function timeUTCToDOS(timestamp = new Date()) {
    let fatTime = 0;
    fatTime |= timestamp.getUTCSeconds() >> 1;
    fatTime |= timestamp.getUTCMinutes() << 5;
    fatTime |= timestamp.getUTCHours() << 11;
...
export function dateUTCToDOS(timestamp = new Date()) {
    let fatTime = 0;
...
export function dateTimeUTCFromDOS(fatTime = 0, timestamp = new Date(0)) {
...
export function timeUTCFromDOS(fatTime = 0, timestamp = new Date(0)) {
    timestamp.setUTCSeconds(fatTime << 1 & 0b11111);
    timestamp.setUTCMinutes(fatTime >> 5 & 0b111111);
    timestamp.setUTCHours(fatTime >> 11 & 0b11111);
    return timestamp;
...
export function dateUTCFromDOS(fatTime = 0, timestamp = new Date(0)) {
