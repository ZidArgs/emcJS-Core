...
import STYLE from "./ComparatorGreaterThanEqual.js.css" assert {type: "css"};

const TPL_CAPTION = "GTE (>=)";
const REFERENCE = "gte";

export default class ComparatorGreaterThanEqual extends AbstractTwoChildrenElement {
